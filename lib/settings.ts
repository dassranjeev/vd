...
export const seoSchema = z.object({
  ...
  canonicalUrl: z.string().default("https://www.vivekdas.ca"),
  ...
  seo: {
    ...
    fields: [
      ...
      { name: "keywords", label: "Keywords", kind: "textarea" },
      {
        ...
        label: "Canonical URL",
        kind: "text",
        placeholder: "https://www.vivekdas.ca",
        help: "Must match the primary domain in Vercel, including www or not. Drives canonical tags, the sitemap and robots.txt.",
      },
